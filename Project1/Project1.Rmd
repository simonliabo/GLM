...
\begin{equation}
\begin{split}
  \hat\beta_0 &= \log(\lambda_0) -\frac{\theta^2}{2\omega^2}\\ 
  \hat\beta_1 &= \frac{\theta}{\omega^2}\\ 
  \hat\beta_2 &= -\frac{1}{2\omega^2}
\end{split}
\end{equation}
...
By using the equations and chunk above we have found that $\omega=`r omega`$ and $\theta=`r theta`$.
